...
curl -o .claude/commands/panel.md https://raw.githubusercontent.com/Todmy/synthetic-panel/main/panel.md
curl -o .claude/commands/panel-engine.md https://raw.githubusercontent.com/Todmy/synthetic-panel/main/panel-engine.md
```

Two files: `panel.md` (routing + init wizard, ~500 words) and `panel-engine.md` (evaluation engine + presets, loaded only during evaluation).
...
```
.claude/commands/
├── panel.md               ← routing + init wizard (~500 words, always loaded)
└── panel-engine.md        ← evaluation engine + presets (loaded on demand)
